(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@bemoje/assert-type'), require('@bemoje/is-function'), require('@bemoje/is-string'), require('@bemoje/math-log10-approx'), require('@bemoje/math-pow10-pre-computed'), require('@bemoje/o-get')) :
	typeof define === 'function' && define.amd ? define(['@bemoje/assert-type', '@bemoje/is-function', '@bemoje/is-string', '@bemoje/math-log10-approx', '@bemoje/math-pow10-pre-computed', '@bemoje/o-get'], factory) :
	(global = global || self, global['arr-sort-comparator'] = factory(global.assertType, global.isFunction, global.isString, global.log10, global.POW10, global.oGet));
}(this, (function (assertType, isFunction, isString, log10, POW10, oGet) { 'use strict';
	...
	log10 = log10 && Object.prototype.hasOwnProperty.call(log10, 'default') ? log10['default'] : log10;
	POW10 = POW10 && Object.prototype.hasOwnProperty.call(POW10, 'default') ? POW10['default'] : POW10;
	oGet = oGet && Object.prototype.hasOwnProperty.call(oGet, 'default') ? oGet['default'] : oGet;
